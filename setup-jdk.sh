...
pacman -Sy --noconfirm binutils wget desktop-file-utils libxrender libxslt libxtst shared-mime-info hicolor-icon-theme java-environment-common java-runtime-common xdg-utils fakeroot
